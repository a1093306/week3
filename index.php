...
<body>
    ...
    <a href="http://uukt.com.tw/attraction/4"> <img src="https://img.uukt.com.tw/view/4/1080/201611092225213f7pB.jpg" border='2'width="42%"></a>
    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <a href="http://uukt.com.tw/attraction/41"> <img src="https://img.uukt.com.tw/view/41/1080/20191017115753dar4w.jpg" border='2' width="43%"></a><br/>
    <br/>
    <form>
        <font  face="Times New Roman" size='5'>
            ...
            <br/>
            Please input T-shirt Color:&nbsp&nbsp<input type="color" name="PWD"><br/>
            Please input your Birthday:&nbsp&nbsp<input type="date" name="birthday"><br/>
            Please input Ticket Number:&nbsp&nbsp<input type="number" name="ticket"><br/>    
        </font>
        <input type="submit">
    </form>
